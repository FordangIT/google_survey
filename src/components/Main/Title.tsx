...
function Title() {
  ...
  return (
    <>
      <div className="flex justify-center lg:relative md:ml-[4.2rem]">
        <div className="pt-3">
          <div className=" w-[380px] md:w-[655px] lg:w-[855px] h-3 bg-dark-purple rounded-t-lg "></div>
          <div className=" w-[380px] md:w-[655px] lg:w-[855px] h-36 bg-white rounded-b-lg flex flex-col">
            <input
              type="text"
